...
- The frontend data models are in client/src/common/types. The backend data models in server/src/app/data must also be kept in sync when changes are made.
