...
class TestTokenRefreshFlow:
    ...
    def test_refresh_access_token_failures(self, db_session, test_user: User, invalid_scenario: str):
        ...
        if invalid_scenario == "invalid_token":
            ...
            expires_delta = timedelta(seconds=-1)
            token = create_refresh_token(data={"sub": test_user.username}, expires_delta=expires_delta)
...
class TestUserAuthentication:
    ...
    def test_get_current_user_failures(self, db_session, test_user: User, failure_scenario: str):
