...
def upgrade() -> None:
    ...
    op.add_column(
        "ingredients", sa.Column("new_recipe_id", sa.String(15), nullable=True)
    )
    op.add_column("instructions", sa.Column("new_id", sa.String(15), nullable=True))
    op.add_column(
        "instructions", sa.Column("new_recipe_id", sa.String(15), nullable=True)
    )
    op.add_column(
        "recipe_permissions", sa.Column("new_id", sa.String(17), nullable=True)
    )
    op.add_column(
        "recipe_permissions", sa.Column("new_user_id", sa.String(15), nullable=True)
    )
    op.add_column(
        "recipe_permissions", sa.Column("new_recipe_id", sa.String(15), nullable=True)
    )
    op.add_column(
        "recipe_permissions", sa.Column("new_granted_by", sa.String(15), nullable=True)
    )
    op.add_column(
        "security_audit_logs", sa.Column("new_id", sa.String(17), nullable=True)
    )
    op.add_column(
        "security_audit_logs", sa.Column("new_user_id", sa.String(15), nullable=True)
    )
    ...
    ingredients = connection.execute(
        text("SELECT id, recipe_id FROM ingredients ORDER BY id")
    ).fetchall()
    for ingredient in ingredients:
        ...
        connection.execute(
            text(
                "UPDATE ingredients SET new_id = :new_id, new_recipe_id = :new_recipe_id WHERE id = :old_id"
            ),
    ...
    instructions = connection.execute(
        text("SELECT id, recipe_id FROM instructions ORDER BY id")
    ).fetchall()
    for instruction in instructions:
        ...
        connection.execute(
            text(
                "UPDATE instructions SET new_id = :new_id, new_recipe_id = :new_recipe_id WHERE id = :old_id"
            ),
            {"new_id": new_id, "new_recipe_id": new_recipe_id, "old_id": old_id},
        )
    ...
    permissions = connection.execute(
        text(
            "SELECT id, user_id, recipe_id, granted_by FROM recipe_permissions ORDER BY id"
        )
    ).fetchall()
    ...
    logs = connection.execute(
        text("SELECT id, user_id FROM security_audit_logs ORDER BY id")
    ).fetchall()
    for log in logs:
        ...
        connection.execute(
            text(
                "UPDATE security_audit_logs SET new_id = :new_id, new_user_id = :new_user_id WHERE id = :old_id"
            ),
    ...
    op.drop_constraint(
        "instructions_recipe_id_fkey", "instructions", type_="foreignkey"
    )
    op.drop_constraint(
        "recipe_permissions_user_id_fkey", "recipe_permissions", type_="foreignkey"
    )
    op.drop_constraint(
        "recipe_permissions_recipe_id_fkey", "recipe_permissions", type_="foreignkey"
    )
    op.drop_constraint(
        "recipe_permissions_granted_by_fkey", "recipe_permissions", type_="foreignkey"
    )
    op.drop_constraint(
        "security_audit_logs_user_id_fkey", "security_audit_logs", type_="foreignkey"
    )
    ...
    op.alter_column(
        "ingredients", "new_recipe_id", new_column_name="recipe_id", nullable=False
    )
    ...
    op.alter_column(
        "instructions", "new_recipe_id", new_column_name="recipe_id", nullable=False
    )
    ...
    op.alter_column(
        "recipe_permissions", "new_id", new_column_name="id", nullable=False
    )
    op.alter_column(
        "recipe_permissions", "new_user_id", new_column_name="user_id", nullable=False
    )
    op.alter_column(
        "recipe_permissions",
        "new_recipe_id",
    ...
    op.alter_column(
        "security_audit_logs", "new_id", new_column_name="id", nullable=False
    )
    op.alter_column(
        "security_audit_logs", "new_user_id", new_column_name="user_id", nullable=True
    )
    ...
    op.create_foreign_key(
        "recipe_permissions_user_id_fkey",
        "recipe_permissions",
        "users",
        ["user_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "recipe_permissions_recipe_id_fkey",
        "recipe_permissions",
        "recipes",
        ["recipe_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "recipe_permissions_granted_by_fkey",
        "recipe_permissions",
        "users",
        ["granted_by"],
        ["id"],
    ...
    op.create_foreign_key(
        "security_audit_logs_user_id_fkey",
        "security_audit_logs",
        "users",
        ["user_id"],
        ["id"],
    ...
    op.create_index(
        "ix_recipe_permissions_recipe_id", "recipe_permissions", ["recipe_id"]
    )
    op.create_index("ix_security_audit_logs_id", "security_audit_logs", ["id"])
    op.create_index(
        "ix_security_audit_logs_user_id", "security_audit_logs", ["user_id"]
    )
