...
class Ingredient(Base):
    ...
    subtext = Column(String(255), nullable=True)  # Additional notes or preparation instructions
    order_index = Column(Integer, nullable=False, default=0)  # Order of ingredient in recipe
