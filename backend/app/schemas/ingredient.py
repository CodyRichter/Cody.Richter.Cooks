...
class IngredientSchema(BaseModel):
    ...
    # Core fields
    name: Optional[str] = Field(None, min_length=1, max_length=255, description="Name of the ingredient")
    ...
    subtext: Optional[str] = Field(None, max_length=255, description="Additional ingredient notes or preparation instructions")
    order_index: Optional[int] = Field(None, ge=0, description="Order of ingredient in the recipe")
    
    # Relationship fields
    recipe_id: Optional[str] = Field(None, description="ID of the recipe this ingredient belongs to")
...
class IngredientListCreate(BaseModel):
    ...
    ingredients: List[IngredientSchema] = Field(..., description="List of ingredients to create")
